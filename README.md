...
Here are the pre-requisites before you invoke the template:
	...
	2. For subscription used to deploy this Azure ARM Template, "Want to deploy programmatically?" option must be enabled for "Citrix NetScaler 11.0 VPX Bring Your Own License" offer within Azure Marketplace.
